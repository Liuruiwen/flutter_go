...
@JsonSerializable()
class ChaptersDatasBean extends Object{
  ...
  ChaptersDatasBean(this.apkLink,this.author,this.chapterId,this.chapterName,this.collect,this.courseId,this.desc,this.envelopePic,this.fresh,this.id,this.link,this.niceDate,this.origin,this.prefix,this.projectLink,this.publishTime,this.superChapterId,this.superChapterName,this.tags,this.title,this.type,this.userId,this.visible,this.zan,);

  factory ChaptersDatasBean.fromJson(Map<String, dynamic> srcJson) => _$ChaptersDatasBeanFromJson(srcJson);

}

ChaptersDatasBean _$ChaptersDatasBeanFromJson(Map<String, dynamic> json) {
  return ChaptersDatasBean(
