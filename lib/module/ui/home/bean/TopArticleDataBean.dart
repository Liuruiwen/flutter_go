 ...
 */
@JsonSerializable()
class TopArticleDataBean extends ObjectBean{
  ...
  factory TopArticleDataBean.fromJson(Map<String, dynamic> srcJson) => _$TopArticleDataBeanFromJson(srcJson);

}

TopArticleDataBean _$TopArticleDataBeanFromJson(Map<String, dynamic> json) {
  return TopArticleDataBean(
